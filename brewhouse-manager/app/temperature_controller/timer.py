...
class Timer:
    ...
    def _tick(self):
        ...
        self._time_remaining = self._duration - (datetime.now() - self._time_started)
...
if __name__ == "__main__":
    timer1 = Timer(tick_interval=1, duration=1, first_immediately=True, timer_name="Timer 1", callback=some_callback)
    try:
        timer1.start()
